  ...
  if (isMobile) {
    return (
      <PaddingContainerMobile>
        ...
        <HorizontalLine />
        <AboutTextMobile>
          O papel do clero regular na catequização dos povos foi fundamental
          para a consolidação do catolicismo na América portuguesa. No além-mar,
          as ordens primeiras possuíam a prerrogativa de administrar sacramentos
          e celebrar missas, tornando-se fortes instrumentos de conversão e
          ...
          pudessem estabelecer vínculos mais fortes com a religião,
          submetendo-se a um estatuto.
        </AboutTextMobile>

        <AboutTextMobile>
          A conversão ao cristianismo não se realizava apenas através das
          palavras, mas também por meio da iconografia sacra, visto que a
          própria Igreja a considerava como sendo uma escrita dos iletrados. Daí
          o cuidado para que essas imagens fossem decorosas, induzindo o
          espectador à verdadeira fé e evitando erros ou exageros. Para isso,
          “copiavam-se” modelos canônicos de imagens que vinham da Europa na
          forma de gravuras.
        </AboutTextMobile>

        <AboutTextMobile>
          O uso de gravuras na produção das imagens sacras ditas “barrocas” na
          América portuguesa já é largamente conhecido pela comunidade
          científica que pesquisa a área. Sabe-se que boa parte da produção
          imagética se inspira nesses gravados produzidos na Europa e
          disseminados em papeis avulsos, dentro de livros, ou em destaques para
          as crônicas religiosas e hagiografias.
        </AboutTextMobile>
        ...
        <AboutTextMobile>
          ...
          apresentaram em formas de monografias, dissertações e teses. No
          entanto, muitas vezes um trabalho iconográfico poderia ser facilitado
          pela construção de um banco de dados que reunisse as pinturas e suas
          matrizes iconográficas, a exemplo do que já ocorre em outros países,
          como o site colonialart, do México.
        </AboutTextMobile>
        ...
        <AboutTextMobile>
          ...
          construção de um sítio eletrônico produzido por discentes da Ciência
          da Computação.
        </AboutTextMobile>
        ...
        <AboutTextMobile>
          ...
          usuários, em que vocês poderão se cadastrar para que suas
          contribuições imagéticas possam figurar no site, abrangendo assim
          pesquisadores a nível nacional e internacional.
        </AboutTextMobile>
        ...
        <AboutUsContainerMobile>
          <AboutUsMobile style={{ textAlign: "start" }}>
